...
- [Linux (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.2/appliance-installer-linux-amd64-1.0.2.tar.gz)
- [Darwin (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.2/appliance-installer-darwin-amd64-1.0.2.tar.gz)
- [Windows (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.2/appliance-installer-windows-amd64-1.0.2.zip)
- [Solaris (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.2/appliance-installer-solaris-amd64-1.0.2.tar.gz)
