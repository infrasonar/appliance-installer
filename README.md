...
- [Linux (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.6/appliance-installer-linux-amd64-1.0.6.tar.gz)
- [Darwin (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.6/appliance-installer-darwin-amd64-1.0.6.tar.gz)
- [Windows (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.6/appliance-installer-windows-amd64-1.0.6.zip)
- [Solaris (amd64)](https://github.com/infrasonar/appliance-installer/releases/download/v1.0.6/appliance-installer-solaris-amd64-1.0.6.tar.gz)
...
```bash
tar -xzvf appliance-installer-linux-amd64-1.0.6.tar.gz
```
